...
open class AsyncIOSurfaceCanvasImpl(
    ...
    private fun initializeThread(){
        ...
        fxContextWrapper = GLContext.create(fxContext, GLProfile.COMPATIBILITY)

        thread(isDaemon = true) {
            context = GLContext.create(0, profile)
            context.makeCurrent()
    ...
    private fun updateSurfaceSize(width: Int, height: Int){
        ...
        ioSurface.cglTexImageIOSurface2D(context,
    ...
    private fun updateResultTextureSize(width: Int, height: Int){
        ...
        ioSurface.cglTexImageIOSurface2D(fxContextWrapper,
            GL_TEXTURE_RECTANGLE,
            GL_RGBA,
            GL_BGRA,
            GL_UNSIGNED_INT_8_8_8_8_REV, 0)
