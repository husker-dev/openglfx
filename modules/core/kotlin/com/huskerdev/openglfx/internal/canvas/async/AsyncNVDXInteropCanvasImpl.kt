...
open class AsyncNVDXInteropCanvasImpl(
    ...
    private fun initializeGLThread(){
        resultContext = GLContext.create(0, profile)

        thread(isDaemon = true) {
            context = GLContext.create(resultContext.handle, profile)
            context.makeCurrent()
    ...
    private fun updateInteropTextureSize(width: Int, height: Int){
        ...
        interopObject = interopDevice.registerObject(fxD3DTexture.handle, resultFBO.texture,
