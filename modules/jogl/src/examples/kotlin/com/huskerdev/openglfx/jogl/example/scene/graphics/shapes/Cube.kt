...
), intArrayOf(0, 1, 2, 3, 7, 1, 5, 4, 7, 6, 2, 4, 0, 1), GL_TRIANGLE_STRIP, transform) {
    constructor(gl: GL3, color: Color, transform: Matrix4):
            this(gl, color, color, color, color, color, color, color, color, transform)
}
